    ...
    <form name="calc">
        <table class="purple-gradient" border=9>
            ...
            <tr>
                ...
                <td><input type="button" value="5" onClick="calc.display.value+='4'"></td>
                <td><input type="button" value="3" onClick="calc.display.value+='5'"></td>
